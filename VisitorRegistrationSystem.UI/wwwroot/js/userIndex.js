$(document).ready(function () {
                                ...
                                $.each(userListDto.Users.$values,
                                    function (index, user) {
                                      const newTableRow= dataTable.row.add([
                                            ...
                                            `
                                <button class="btn btn-primary btn-block btn-sm btn-update" data-id="${user.Id}"><span class="fas fa-edit"></span></button>
                                <button class="btn btn-danger btn-block btn-sm btn-delete" data-id="${user.Id}"><span class="fas fa-minus-circle"></span></button>
                                            `
                                      ]).node();
    ...
    /*Ajax Get/Updating User starts from here*/
        ...
        $(document).on('click',
            ...
            function (event) {
                ...
                $.get(url, { userId: id }).done(function (data) {
                    ...
                    toastr.error("Burada bir hata oluştu");
                });
                    ...
                    success: function (data) {
                        ...
                        if (isValid) {
                            ...
                            dataTable.row(tableRow).data([
                                ...
                                `
                                <button class="btn btn-primary btn-block btn-sm btn-update" data-id="${userUpdateAjaxModel.UserDto.User.Id}"><span class="fas fa-edit"></span></button>
                                <button class="btn btn-danger  btn-block btn-sm btn-delete" data-id="${userUpdateAjaxModel.UserDto.User.Id}"><span class="fas fa-minus-circle"></span></button>
                            `
                            ]);
